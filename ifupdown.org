...
#+BEGIN_SRC C :tangle src/config.c
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
#include <errno.h>
...
- an array of interface names that should be brought up at
  bootup.

- a singly linked list to represent the various mappings.

- another singly linked list to represent the interface
...
#+BEGIN_SRC C :noweb-ref config functions
interfaces_file *read_interfaces(char *filename) {
...
#+BEGIN_SRC C :noweb-ref allocate defn or [[return NULL]]
...
#+BEGIN_SRC C :tangle src/execute.c
<<execute headers>>
...
#+BEGIN_SRC C :noweb-ref execute headers
#include <stdio.h>
#include <ctype.h>
#include <stdlib.h>
#include <string.h>
...
- [[iface_up()]] and [[iface_down()]] which will actually
  configure or deconfigure an interface.

- [[iface_list()]] which permits querying a list of known
  interfaces by class.

- [[iface_query()]], to query configuration details about a
  specific interface by name.

- [[execute()]] which will take an interface definition and
...
- [[run_mapping()]] which will run a mapping script and
